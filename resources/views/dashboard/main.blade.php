          ...
          <div class="row item-blocks-connected">
            ...
            <div class="col-xs-12">
              <a class="item-block" href="job-detail.html">
                <header>
                  <img src="{{ asset('themeforest/img/logo-google.jpg') }}" alt="">
                  <div class="hgroup">
            ...
            <div class="col-xs-12">
              <a class="item-block" href="job-detail.html">
                <header>
                  <img src="{{ asset('themeforest/img/logo-linkedin.png') }}" alt="">
                  <div class="hgroup">
            ...
            <div class="col-xs-12">
              <a class="item-block" href="job-detail.html">
                <header>
                  <img src="{{ asset('themeforest/img/logo-envato.png') }}" alt="">
                  <div class="hgroup">
            ...
            <div class="col-xs-12">
              <a class="item-block" href="job-detail.html">
                <header>
                  <img src="{{ asset('themeforest/img/logo-facebook.png') }}" alt="">
                  <div class="hgroup">
            ...
            <div class="col-xs-12">
              <a class="item-block" href="job-detail.html">
                <header>
                  <img src="{{ asset('themeforest/img/logo-microsoft.jpg') }}" alt="">
                  <div class="hgroup">
      ...
      <section>
        <div class="container">
          ...
          <div class="col-sm-12 col-md-6 hidden-xs hidden-sm">
            <br>
            <img class="center-block" src="{{ asset('themeforest/img/how-it-works.png') }}" alt="how it works">
          </div>
